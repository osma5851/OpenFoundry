...
// OntologyProjectRole mirrors `models::project::OntologyProjectRole`.
...
// Rank mirrors `OntologyProjectRole::rank` (Viewer=1, Editor=2, Owner=3).
...
// OntologyProject mirrors `models::project::OntologyProject`.
