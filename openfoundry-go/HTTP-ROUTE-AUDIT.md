...
Rust routes: 29. Go routes: 61.
State counts: implemented: 61.

| Route | Method | Rust handler | Go handler | State |
| --- | --- | --- | --- | --- |
| `/api/v1/iceberg-tables` | GET | `handlers::admin::list_iceberg_tables`<br><sub>services/iceberg-catalog-service/src/lib.rs:119</sub> | `h.ListIcebergTables`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:66</sub> | implemented |
| `/api/v1/iceberg-tables/{id}` | GET | `handlers::admin::get_iceberg_table_detail`<br><sub>services/iceberg-catalog-service/src/lib.rs:123</sub> | `h.GetIcebergTableDetail`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:67</sub> | implemented |
| `/api/v1/iceberg-tables/{id}/branches` | GET | `handlers::admin::list_iceberg_table_branches`<br><sub>services/iceberg-catalog-service/src/lib.rs:135</sub> | `h.ListIcebergTableBranches`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:70</sub> | implemented |
| `/api/v1/iceberg-tables/{id}/metadata` | GET | `handlers::admin::get_iceberg_table_metadata`<br><sub>services/iceberg-catalog-service/src/lib.rs:131</sub> | `h.GetIcebergTableMetadata`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:69</sub> | implemented |
| `/api/v1/iceberg-tables/{id}/snapshots` | GET | `handlers::admin::list_iceberg_table_snapshots`<br><sub>services/iceberg-catalog-service/src/lib.rs:127</sub> | `h.ListIcebergTableSnapshots`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:68</sub> | implemented |
| `/api/v1/namespaces` | GET | — | `h.ListNamespaces`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:72</sub> | implemented |
| `/api/v1/namespaces` | POST | — | `h.CreateNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:73</sub> | implemented |
| `/api/v1/namespaces/{id}` | DELETE | — | `h.DeleteNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:76</sub> | implemented |
| `/api/v1/namespaces/{id}` | GET | — | `h.GetNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:74</sub> | implemented |
| `/api/v1/namespaces/{id}` | PATCH | — | `h.UpdateNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:75</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables` | GET | — | `h.ListTables`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:78</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables` | POST | — | `h.CreateTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:79</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}` | DELETE | — | `h.DropTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:84</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}` | GET | — | `h.LoadTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:81</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}` | HEAD | — | `h.TableExists`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:82</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}` | POST | — | `h.CommitTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:83</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/metadata` | GET | — | `h.ListMetadataFiles`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:89</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/metadata/{version}` | GET | — | `h.GetMetadataFile`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:90</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/refs` | GET | — | `h.ListRefs`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:85</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | DELETE | — | `h.DeleteRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:88</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | GET | — | `h.GetRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:86</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | PUT | — | `h.UpsertRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:87</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/snapshots` | GET | — | `h.ListSnapshots`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:91</sub> | implemented |
| `/api/v1/namespaces/{namespace}/tables/{table}/snapshots/{snapshot_id}` | GET | — | `h.GetSnapshot`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:92</sub> | implemented |
| `/api/v1/tables/rename` | POST | — | `h.RenameTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:80</sub> | implemented |
| `/health` | GET | `||`<br><sub>services/iceberg-catalog-service/src/lib.rs:144</sub> | `healthHandler`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:54</sub> | implemented |
| `/healthz` | GET | — | `healthHandler`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:53</sub> | implemented |
| `/iceberg/v1/config` | GET | `handlers::rest_catalog::config::get_config`<br><sub>services/iceberg-catalog-service/src/lib.rs:41</sub> | `h.GetConfig`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:135</sub> | implemented |
| `/iceberg/v1/diagnose` | POST | `handlers::diagnose::run_diagnose`<br><sub>services/iceberg-catalog-service/src/lib.rs:99</sub> | `h.RunDiagnose`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:136</sub> | implemented |
| `/iceberg/v1/namespaces` | GET | `handlers::rest_catalog::namespaces::list_namespaces`<br><sub>services/iceberg-catalog-service/src/lib.rs:46</sub> | `h.ListCatalogNamespaces`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:137</sub> | implemented |
| `/iceberg/v1/namespaces` | POST | `handlers::rest_catalog::namespaces::create_namespace`<br><sub>services/iceberg-catalog-service/src/lib.rs:46</sub> | `h.CreateCatalogNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:138</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}` | DELETE | `handlers::rest_catalog::namespaces::drop_namespace`<br><sub>services/iceberg-catalog-service/src/lib.rs:51</sub> | `h.DropCatalogNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:140</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}` | GET | `handlers::rest_catalog::namespaces::load_namespace`<br><sub>services/iceberg-catalog-service/src/lib.rs:51</sub> | `h.LoadCatalogNamespace`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:139</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/markings` | GET | `handlers::markings::get_namespace_markings`<br><sub>services/iceberg-catalog-service/src/lib.rs:88</sub> | `deps.Markings.GetNamespaceMarkings`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:120</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/markings` | POST | `handlers::markings::update_namespace_markings`<br><sub>services/iceberg-catalog-service/src/lib.rs:88</sub> | `deps.Markings.UpdateNamespaceMarkings`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:121</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/properties` | GET | `handlers::rest_catalog::namespaces::get_properties`<br><sub>services/iceberg-catalog-service/src/lib.rs:56</sub> | `h.GetNamespaceProperties`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:141</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/properties` | POST | `handlers::rest_catalog::namespaces::update_properties`<br><sub>services/iceberg-catalog-service/src/lib.rs:56</sub> | `h.UpdateNamespacePropertiesREST`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:142</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables` | GET | `handlers::rest_catalog::tables::list_tables`<br><sub>services/iceberg-catalog-service/src/lib.rs:62</sub> | `h.ListTables`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:143</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables` | POST | `handlers::rest_catalog::tables::create_table`<br><sub>services/iceberg-catalog-service/src/lib.rs:62</sub> | `h.CreateTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:144</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}` | DELETE | `handlers::rest_catalog::tables::drop_table`<br><sub>services/iceberg-catalog-service/src/lib.rs:67</sub> | `h.DropTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:149</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}` | GET | `handlers::rest_catalog::tables::load_table`<br><sub>services/iceberg-catalog-service/src/lib.rs:67</sub> | `h.LoadTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:146</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}` | HEAD | `handlers::rest_catalog::tables::table_exists`<br><sub>services/iceberg-catalog-service/src/lib.rs:73</sub> | `h.TableExists`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:147</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}` | POST | `handlers::rest_catalog::tables::commit_table`<br><sub>services/iceberg-catalog-service/src/lib.rs:67</sub> | `h.CommitTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:148</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/alter-schema` | POST | `handlers::rest_catalog::tables::alter_schema`<br><sub>services/iceberg-catalog-service/src/lib.rs:78</sub> | `h.AlterSchema`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:158</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/markings` | GET | `handlers::markings::get_table_markings`<br><sub>services/iceberg-catalog-service/src/lib.rs:93</sub> | `deps.Markings.GetTableMarkings`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:125</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/markings` | PATCH | `handlers::markings::update_table_markings`<br><sub>services/iceberg-catalog-service/src/lib.rs:93</sub> | `deps.Markings.UpdateTableMarkings`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:126</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/metadata` | GET | — | `h.ListMetadataFiles`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:154</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/metadata/{version}` | GET | — | `h.GetMetadataFile`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:155</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/refs` | GET | — | `h.ListRefs`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:150</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | DELETE | — | `h.DeleteRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:153</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | GET | — | `h.GetRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:151</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/refs/{ref}` | PUT | — | `h.UpsertRef`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:152</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/snapshots` | GET | — | `h.ListSnapshots`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:156</sub> | implemented |
| `/iceberg/v1/namespaces/{namespace}/tables/{table}/snapshots/{snapshot_id}` | GET | — | `h.GetSnapshot`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:157</sub> | implemented |
| `/iceberg/v1/oauth/tokens` | POST | `handlers::auth::oauth::issue_token`<br><sub>services/iceberg-catalog-service/src/lib.rs:108</sub> | `auth.IssueTokenHandler(deps.Bearer`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:99</sub> | implemented |
| `/iceberg/v1/tables/rename` | POST | — | `h.RenameTable`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:145</sub> | implemented |
| `/iceberg/v1/transactions/commit` | POST | `handlers::rest_catalog::transactions::multi_table_commit`<br><sub>services/iceberg-catalog-service/src/lib.rs:83</sub> | `h.MultiTableCommit`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:159</sub> | implemented |
| `/metrics` | GET | `metrics::render_metrics`<br><sub>services/iceberg-catalog-service/src/lib.rs:145</sub> | `m.Handler(`<br><sub>openfoundry-go/services/iceberg-catalog-service/internal/server/server.go:56</sub> | implemented |
